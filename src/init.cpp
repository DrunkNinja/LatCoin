...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: latcoin.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: latcoind.pid)") + "\n";
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 10523 or testnet: 20523)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 10524 or testnet: 20524)") + "\n";
    ...
    strUsage += "\n" + _("SSL options: (see the LatCoin Wiki for SSL setup instructions)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. LatCoin is probably already running."), strDataDir.c_str()));
